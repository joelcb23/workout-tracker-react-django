...
export const updateExerciseRequest =async(routineId, exerciseId, data)=>
  await api.put(`/routines/routine/${routineId}/update-exercise/${exerciseId}`, data);

export const deleteExerciseRequest =async(routineId, exerciseId)=>
  await api.delete(`/routines/routine/${routineId}/delete-exercise/${exerciseId}`);
...
export const unmarkSetRequest = async (routine_id) =>
  await api.put(
    `/routines/routine/${routine_id}/unmark-set-done`
  );
